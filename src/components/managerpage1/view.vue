<template>
  <div>
    ...
    <el-dialog title="项目详情" :visible.sync="dialogVisible" width="40%">
      <table id="td"   cellspacing="0" cellpadding="0">
        ...
        <tr>
        <td class="tdname">项目状态：</td>
        <td class="tinfo">{{tstate}}</td>
      </tr>
        <tr>
        <td class="tdname">项目评估：</td>
        <td class="tinfo">{{tassess}}</td>
      </tr>
        <tr>
        <td class="tdname">经费使用情况：</td>
        <td class="tinfo">{{tusedmoney}}</td>
      </tr>
       <tr>
        <td class="tdname">经费批准情况：</td>
        <td class="tinfo">{{tmoneystate}}</td>
      </tr>
      </table>
    </el-dialog>
        ...
        this.gridData = [];
          ...
          this.$http
            ...
            .then(response => {
              ...
              this.tassess = this.gridData[0].assess;
              this.tusedmoney =this.gridData[0].usedmoney;
              this.tmoneystate = this.gridData[0].moneystate;
              this.tresult = '';
              if(this.tresult1 == '1'){
                this.tresult += '实物、'
              }
